...
const ProfileAttachmentFormScreen = (props: any) => {
    ...
    return <ProfileAttachmentFormScreenComponent 
        ...
        savePersonalInformation={props.savePersonalInformation}
        values={props.values}
        inputChange={props.inputChange}
        selectPhoto={props.selectPhoto}
        takePhoto={props.takePhoto}
        back={props.back}
        onPressRemovePhoto={props.onPressRemovePhoto}
    />
}

export default ProfileAttachmentFormScreen

class ProfileAttachmentFormScreenComponent extends React.Component<any> {
